...
2. Pre-commit hooks are automatically configured to run linting and formatting on changed files. You can also manually run `npm run pre-push` to verify lint, TS and tests.
